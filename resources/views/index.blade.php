...
<head lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('blog-theme/app/css/normalize.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('blog-theme/app/css/grid.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('blog-theme/app/css/styles.css') }}">


    <!--Plugins styles-->

    <link rel="stylesheet" type="text/css" href="{{ asset('blog-theme/app/css/jquery.mCustomScrollbar.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('blog-theme/app/css/swiper.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('blog-theme/app/css/primary-menu.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('blog-theme/app/css/magnific-popup.css') }}">
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb">
                                            <img src="{{ asset('blog-theme/app/img/3.jpg')}}" alt="our case">
                                        </div>
                                ...
                                <div class="col-lg-4  col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb">
                                            <img src="{{ asset('blog-theme/app/img/1.png')}}" alt="our case">
                                        </div>
                                ...
                                <div class="col-lg-4  col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb mouseover poster-3d lightbox shadow animation-disabled" data-offset="5">
                                            <img src="{{ asset('blog-theme/app/img/2.png')}}" alt="our case">
                                        </div>
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                ...
                                <div class="col-lg-4  col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb mouseover poster-3d lightbox shadow animation-disabled" data-offset="5">
                                            <img src="{{ asset('blog-theme/app/img/4.jpg')}}" alt="our case">
                                        </div>
                                        <h6 class="case-item__title">quod mazim placerat facer possim assum</h6>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb">
                                            <img src="{{ asset('blog-theme/app/img/5.jpg')}}" alt="our case">
                                        </div>
                                        <h6 class="case-item__title"><a href="#">Investigationes demonstraverunt legere</a></h6>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4  col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb mouseover poster-3d lightbox shadow animation-disabled" data-offset="5">
                                            <img src="{{ asset('blog-theme/app/img/6.jpg')}}" alt="our case">
                                        </div>
                                        <h6 class="case-item__title">quod mazim placerat facer possim assum</h6>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="subscribe scrollme">
                        ...
                        <div class="images-block">
                            <img src="{{ asset('blog-theme/app/img/subscr-gear.png')}}" alt="gear" class="gear">
                            <img src="{{ asset('blog-theme/app/img/subscr1.png')}}" alt="mail" class="mail">
                            <img src="{{ asset('blog-theme/app/img/subscr-mailopen.png')}}" alt="mail" class="mail-2">
                        </div>
                    </div>
                </div>
            </div>
...
<script src="{{ asset('blog-theme/app/js/jquery-2.1.4.min.js') }}"></script>
<script src="{{ asset('blog-theme/app/js/crum-mega-menu.js') }}"></script>
<script src="{{ asset('blog-theme/app/js/swiper.jquery.min.js') }}"></script>
<script src="{{ asset('blog-theme/app/js/theme-plugins.js') }}"></script>
<script src="{{ asset('blog-theme/app/js/main.js') }}"></script>

<script src="{{ asset('blog-theme/app/js/velocity.min.js') }}"></script>
<script src="{{ asset('blog-theme/app/js/ScrollMagic.min.js') }}"></script>
<script src="{{ asset('blog-theme/app/js/animation.velocity.min.js') }}"></script>
