                ...
                <div class="col-lg-10 col-lg-offset-1">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post-additional-info">
                                ...
                                <i class="seoicon-tags"></i>
                                    <a href="{{ route('category.single', ['id' => $post->category->id ]) }}">{{ $post->category->title }}</a>
                    ...
                    <div class="blog-details-author">
                        ...
                        <div class="blog-details-author-thumb">
                            <img src="blog-theme/app/blog-details-author.png" alt="Author">
                        </div>
                        ...
                        <div class="blog-details-author-content">
                            ...
                            <div class="socials">
                                ...
                                <a href="#" class="social__item">
                                    <img src="blog-theme/app/svg/circle-facebook.svg" alt="facebook">
                                </a>

                                <a href="#" class="social__item">
                                    <img src="blog-theme/app/svg/twitter.svg" alt="twitter">
                                </a>

                                <a href="#" class="social__item">
                                    <img src="blog-theme/app/svg/google.svg" alt="google">
                                </a>

                                <a href="#" class="social__item">
                                    <img src="blog-theme/app/svg/youtube.svg" alt="youtube">
                                </a>
